...
import { getAbout } from "@/utils/reader";
        ...
        <div className="max-w-[720px] mx-auto space-y-12">
          <div className="space-y-6">
            ...
            <div className="prose-magazine">
              {data?.mission ? (
                <CleanDocumentRenderer document={data.mission} />
              ) : (
                <>
                  <p>
          ...
          <div className="space-y-6">
            ...
            <div className="prose-magazine">
              {data?.history ? (
                <CleanDocumentRenderer document={data.history} />
              ) : (
                <>
                  <p>
          ...
          <div className="space-y-6">
            ...
            <div className="prose-magazine">
              {data?.journey ? (
                <CleanDocumentRenderer document={data.journey} />
              ) : (
                <>
                  <p>
